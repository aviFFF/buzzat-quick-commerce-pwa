          ...
          <CollapsibleSection title="Contact Us">
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin size={18} className="text-emerald-600 mr-2 mt-1 flex-shrink-0" />
                <span className="text-gray-600">123 Main Street, City, State, 110001</span>
              </li>
              <li className="flex items-center">
                <Phone size={18} className="text-emerald-600 mr-2 flex-shrink-0" />
                <a href="tel:+919876543210" className="text-gray-600 hover:text-emerald-600">+91 98765 43210</a>
              </li>
              <li className="flex items-center">
                <Mail size={18} className="text-emerald-600 mr-2 flex-shrink-0" />
                <a href="mailto:support@example.com" className="text-gray-600 hover:text-emerald-600">support@example.com</a>
              </li>
            </ul>
          </CollapsibleSection>
